...
// // Logs number
// console.log(typeof myNumberDecimal, myNumberDecimal); // number
...
// Logs number
var myVariable = 33;
console.log(typeof myVariable, myVariable); //number, 33
console.log(typeof myVariable + " " + myVariable); //number, 33
...
myVariable = "true";
console.log(typeof myVariable, myVariable); //string, true
